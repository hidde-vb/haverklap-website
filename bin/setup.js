...
const questions = [
  ...
  {
    name: 'accessToken',
    when: !argv.accessToken && !process.env.CONTENTFUL_ACCESS_TOKEN && !argv.deliveryToken && !process.env.CONTENTFUL_DELIVERY_TOKEN,
...
inquirer
  ...
  .then(({ spaceId, managementToken, accessToken }) => {
    ...
    // will work.
    accessToken = CONTENTFUL_ACCESS_TOKEN || CONTENTFUL_DELIVERY_TOKEN || argv.accessToken || argv.deliveryToken || accessToken;
